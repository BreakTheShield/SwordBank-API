...
router.post('/', [validateUserToken,encryptResponse,decryptRequest], (req, res) => {         //sms로 받은 인증번호 보내주는 요청
   var r = new Response();
   var username = req.username;
   ...
   Model.users.findOne({
    ...
    where:{
        ...
        axios({
            ...
            console.log("88888888888888888888888888888888",r.data);
